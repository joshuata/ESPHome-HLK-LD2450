...
namespace esphome::ld2450
{
    ...
    void LD2450::dump_config()
    {
        ...
        ESP_LOGCONFIG(TAG, "  max_detection_tilt_angle: %f °", max_detection_tilt_angle_);
        ESP_LOGCONFIG(TAG, "  min_detection_tilt_angle: %f °", min_detection_tilt_angle_);
        ...
        ESP_LOGCONFIG(TAG, "  tilt_angle_margin: %f °", tilt_angle_margin_);
#ifdef USE_BINARY_SENSOR
